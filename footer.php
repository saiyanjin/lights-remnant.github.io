<!-- FOOTER -->
    ...
    <footer id="reseaux" class="text-center text-lg-start mt-5" style="background-color: #1f1f1f;">
      ...
      <div id="btn-res">
          ...
          <a href="https://github.com/saiyanjin/lights-remnant.github.io" class="bouton" id="github">
        ...
        <div class="text-center text-white p-3">
          <a href="#home" class="mx-3"><img src="images/lanterne.gif" class="rounded" style="height: 50px; width: 50px"></a>
        </div>

      <div class="text-center text-white p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        2025 - Fait par :
        <a class="text-white" href="https://github.com/saiyanjin/lights-remnant.github.io">Light's Remnant</a>
      </div>
